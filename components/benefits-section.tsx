        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="bg-card border border-border rounded-xl p-8 text-center group hover:shadow-lg transition-all">
            <img
              ...
              alt="Dueño de inmobiliaria de lujo"
              className="w-full rounded-lg mb-6"
            />
            <h4 className="text-xl font-bold mb-4">Dueño de inmobiliaria de lujo</h4>
          ...
          <div className="bg-card border border-border rounded-xl p-8 text-center group hover:shadow-lg transition-all">
            ...
            <p className="text-muted-foreground">que busca resultados sin contratar más personal</p>
          </div>
        </div>
